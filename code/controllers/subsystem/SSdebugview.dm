...
/client/proc/ss_breakdown()
	...
	for(var/datum/controller/subsystem/SS as anything in Master.subsystems)
		...
		html += "[SS.state_color()]\[[SS.state_letter()]][SS.ss_id]</font>\t[SS.get_cost()]ms | [round(SS.tick_usage, 1)]% [SS.get_stat_details() ? "| [SS.get_stat_details()] " : ""]| <a href=byond://?_src_=vars;Vars=[SS.UID()]>VV Edit</a>"
