...
/mob/living/carbon/human/attacked_by__legacy__attackchain(obj/item/I, mob/living/user, def_zone)
	...
	var/armor = run_armor_check(affecting, MELEE, "<span class='warning'>Your armor has protected your [hit_area].</span>", "<span class='warning'>Your armor has softened hit to your [hit_area].</span>", armor_penetration_flat = I.armor_penetration_flat, armor_penetration_percentage = I.armor_penetration_percentage)
	if(armor == INFINITY)
		return FALSE
