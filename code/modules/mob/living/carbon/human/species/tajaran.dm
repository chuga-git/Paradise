/datum/species/tajaran
	...
	has_organ = list(
		...
		"eyes" =     /obj/item/organ/internal/eyes/tajaran /*Most Tajara see in full color as a result of genetic augmentation, although it cost them their darksight (darksight = 2)
