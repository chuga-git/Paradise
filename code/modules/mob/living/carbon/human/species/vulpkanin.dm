/datum/species/vulpkanin
	...
	has_organ = list(
		...
		"eyes" =     /obj/item/organ/internal/eyes/vulpkanin /*Most Vulpkanin see in full color as a result of genetic augmentation, although it cost them their darksight (darksight = 2)
															unless they choose otherwise by selecting the colorblind disability in character creation (darksight = 8 but colorblind).*/
		)
