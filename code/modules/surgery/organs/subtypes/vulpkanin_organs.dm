...
/obj/item/organ/internal/eyes/vulpkanin
	...
	icon = 'icons/obj/species_organs/vulpkanin.dmi'
	colorblind_matrix = MATRIX_VULP_CBLIND //The color matrix and darksight parameters that the mob will receive when they get the disability.
	replace_colors = PROTANOPIA_COLOR_REPLACE
	see_in_dark = 4

/// Being the lesser form of Vulpkanin, Wolpins have an utterly incurable version of their colorblindness.
